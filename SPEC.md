...
JSON task/rubric preparation through the native workflow, with bounded live
preparation and [execution/grading acceptance](docs/execution-roles.md#live-native-direct-and-claude-grading).
Broader semantics, source research and general preparer reliability remain outstanding.
...
2. **Execution and grading across the required roles (Y03, Y04, Y05, Y07).** Add
   ...
   Native-direct and Claude Code grading have bounded live acceptance. API live
   inference, additional native subject/builder roles and broader cross-vendor
   verification remain open. Preserve existing execution and evidence boundaries; verify each newly
